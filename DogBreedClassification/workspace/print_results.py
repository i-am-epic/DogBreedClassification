...
def print_results(results_dic, results_stats_dic, model,
    ...
    """
    print("\n\n*** Result for the CNN model architecture", model.upper(), "***")
    ...
    if (print_incorrect_dogs and ((results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'])
        ...
        for key in results_dic:
            # when classification is not a dog when it is a dog
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0):
                print("Image Label", results_dic[key][0])
                print("Classifier Label", results_dic[key][1])

            # when classification is a dog when it is not a dog
